window.jwplayer = (function (t) {
                    ...
                    (o = [
                        {
                            ...
                            value: function (t) {
                                var e = t % 1e3,
                                    ...
                                    r = t;
                                return (
                                    e >= 400 && e < 600 && (r = "".concat(n, "400-").concat(n, "599")),
                                    "JW Player "
                                        .concat(t > 299999 && t < 4e5 ? "Warning" : "Error", " ")
                                        .concat(t, ". For more information see https://developer.jwplayer.com/jw-player/docs/developer-guide/api/errors-reference#")
                                        .concat(r)
                                );
                            },
                        },
    ...
    function (t, e, n) {
        ...
        function T(t, e) {
            ...
            (r.href = t), (r.target = e), (r = Object(i.k)(r, n)), u.Browser.firefox ? r.dispatchEvent(new MouseEvent("click", { bubbles: !0, cancelable: !0, view: window })) : r.click();
        }
        function A() {
    ...
    function (t, e, n) {
        ...
        var r = "free",
            ...
            p = "invalid";
        function h(t) {
            var e = { setup: [r, i, o, u, a, c, l, f, d, s], drm: [a, c, l, f, d], ads: [l, f, d, s, a, c, o], jwpsrv: [r, i, o, u, a, c, l, d, s, p], discovery: [l, a, c, d, f] };
            return function (n) {
            ...
            var k = Object(r.k)(
                ...
                C = (function (t, e) {
                    return function (t, n) {
                        ...
                        if ((clearTimeout(e.timeoutId), e.retryWithoutCredentials && e.xhr.withCredentials)) return y(i), void m(Object(r.k)({}, e, { xhr: null, withCredentials: !1, retryWithoutCredentials: !1 }));
    ...
    function (t, e, n) {
        ...
        e.a = function (t) {
            ...
            return (
                ...
                u(e.tracks) || (e.tracks = []),
                u(e.captions) && ((e.tracks = e.tracks.concat(e.captions)), delete e.captions),
    ...
    function (t, e, n) {
        ...
        e.a = function (t) {
            if (t && t.file) {
                ...
                var n = /^[^/]+\/(?:x-)?([^/]+)$/;
                if (
                    (n.test(e.type) && ((e.mimeType = e.type), (e.type = e.type.replace(n, "$1"))),
                        ...
                        if ((clearTimeout(h), t.el))
                            if ((I(t), M(t, y), t.dragged)) (t.dragged = !1), N(t, i.t, n);
                                ...
                                !(function (t, e, n) {
                                    ...
                                    o ? N(t, i.n, n) : (N(t, i.sb, n), "touchend" !== n.type || j || R(n));
                            }
                    };
                b ? F(t, "init", "pointerdown", o, r) : (m && F(t, "init", "mousedown", o, r), F(t, "init", "touchstart", o, r)),
    ...
    function (t, e, n) {
        ...
        var r = function (t, e, n, r) {
                ...
                return (
                    ...
                    '[id="'.concat(t, '"].jw-error{background:#000;overflow:hidden;position:relative}') +
                    '[id="'.concat(t, '"] .jw-error-msg{top:50%;left:50%;position:absolute;transform:translate(-50%,-50%)}') +
                    '[id="'.concat(t, '"] .jw-error-text{text-align:start;color:#FFF;font:14px/1.35 Arial,Helvetica,sans-serif}') +
                    '</style><div class="jw-icon jw-reset"></div><div class="jw-info-container jw-reset">' +
                    '<div class="jw-error-text jw-reset-text" dir="auto">'.concat(e || "", '<span class="jw-break jw-reset"></span>').concat(i, "</div>") +
                    "</div></div></div>"
                );
            },
            i = n(6),
        ...
        function u(t, e) {
            var n = e.message,
                ...
                s = t.get("height"),
                l = Object(i.e)(a);
            return Object(o.d)(l, { width: c.toString().indexOf("%") > 0 ? c : "".concat(c, "px"), height: s.toString().indexOf("%") > 0 ? s : "".concat(s, "px") }), l;
        }
        n.d(e, "a", function () {
            return u;
        });
                        ...
                        switch (Object(r.b)(l).toLowerCase()) {
                            case "content":
                                if ((Object(i.j)(l, "duration") && (n.duration = Object(i.g)(Object(i.j)(l, "duration"))), Object(i.j)(l, "url"))) {
                                    n.sources || (n.sources = []);
                                    var f = { file: Object(i.j)(l, "url"), type: Object(i.j)(l, "type"), width: Object(i.j)(l, "width"), label: Object(i.j)(l, "label") },
                                        d = o(l);
                                ...
                                (p.file = Object(i.j)(l, "url")),
                                    ...
                                    Object(i.j)(l, "lang").length > 0 &&
                                        (p.label =
                                            ((u = Object(i.j)(l, "lang")),
                                            (a = void 0),
                                            (a = { zh: "Chinese", nl: "Dutch", en: "English", fr: "French", de: "German", it: "Italian", ja: "Japanese", pt: "Portuguese", ru: "Russian", es: "Spanish" })[u] ? a[u] : u)),
                                    c.push(p);
                        }
                    }
                }
    ...
    function (t, e, n) {
        ...
        var d = function (t, e) {
                ...
                return (
                    (h.bandwidthEstimate = Object(r.A)(k) ? k : ((j = h.defaultBandwidthEstimate), (O = parseFloat(j)), Object(r.A)(O) ? Math.max(O, 1) : f.bandwidthEstimate)),
        ...
        var C = function (t, e) {
                ...
                if (
                    ("free" === c.edition() &&
                        (o = Object(r.k)(
                            { skin: { active: "#ff0046", timeslider: { progress: "none" } }, logo: { position: "control-bar", file: y.a } },
                            f,
                            Object(r.E)(o, ["analytics", "aspectratio", "base", "file", "height", "playlist", "sources", "width"])
                        )),
                    (o.key = a),
                    (o.edition = s),
                    (o.error = c.error()),
                ...
                if (
                    ...
                    (o.plugins = (function (t) {
                        ...
                        return (t.related = Object(r.k)({}, c, { disableRelated: s, showButton: l, oncomplete: d, autoplaytimer: p, shouldAutoAdvance: h })), e;
                    })(o)),
                    o.ab &&
                        (o.ab = (function (t) {
                            var e = t.ab;
    ...
    function (t, e, n) {
        ...
        var U = Q,
            ...
            tt = r.g.extend,
            et = {};
        (et._ = r.g), (et.utils = Object(r.k)(B, { key: K.b, extend: tt, scriptloader: J.a, rssparser: { parse: $.a }, tea: Z.a, UI: Y.a })), (et.utils.css.style = et.utils.style), (et.vid = G.a);
        var nt = et,
            rt = n(63),
